...
#[TestSuite("SqliteCachePool")]
#[RequiresPhpExtension("redis")]
#[Group("cachePools")]
#[Group("sqlite")]
final class SqliteCachePoolTest extends TestCase
{
    public function testSingleKeyProcess(): void
    {
        ...
        $value = "def";
        $ttl = 30;
        $pool = new SqliteCachePool(new Sqlite("sqlite::memory:"));
    ...
    public function testDefaultTtl(): void
    {
        $key = "ttl";
        $value = "abc";
        $pool = new SqliteCachePool(new Sqlite("sqlite::memory:"), defaultTtl: -1);
    ...
    {
        $key1 = "one";
        $pool1 = new SqliteCachePool(new Sqlite("sqlite::memory:"));
        $this->assertSame($key1, $pool1->getKey($key1));

        $key2 = "two";
        $namespace = "test";
        $pool2 = new SqliteCachePool(new Sqlite("sqlite::memory:"), namespace: $namespace);
    ...
    public function testEvents(): void
    {
        ...
        $pool = new SqliteCachePool(new Sqlite("sqlite::memory:"), eventDispatcher: $eventDispatcher);
        $key = "one";
        $value = "abc";
        $pool->getItem($key);
